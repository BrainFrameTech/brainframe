...
/// near the limit, which is a button to a fuller explanation; or, for a
/// plain-file note, the line that says which regime it is in. That slot is
/// the one place a user can find out whether a note keeps a history, which
/// is why it is here and not in the tree.
///
